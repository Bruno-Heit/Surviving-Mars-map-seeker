...
class Ui_ResourcesDataWidget(object):
    def setupUi(self, ResourcesDataWidget):
        ...
        ResourcesDataWidget.setToolTip(u"<html><head/><body><p><span style=\" font-size:14pt;\">Niveles de recursos que hay inicialmente en el mapa.</span></p><p><span style=\" font-size:14pt;\">Los niveles var\u00edan entre 1 y 4, siendo 1 escasez de un recurso y 4 su abundancia.</span></p></body></html>")
...
#if QT_CONFIG(tooltip)
        self.label_metals_icon.setToolTip(u"<html><head/><body><p><span style=\" font-size:14pt;\">Metales comunes disponibles inicialmente en el mapa</span></p></body></html>")
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_rare_metals_icon.setToolTip(u"<html><head/><body><p><span style=\" font-size:14pt;\">Metales raros disponibles inicialmente en el mapa</span></p></body></html>")
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_concrete_icon.setToolTip(u"<html><head/><body><p><span style=\" font-size:14pt;\">Concreto disponible inicialmente en el mapa</span></p></body></html>")
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_water_icon.setToolTip(u"<html><head/><body><p><span style=\" font-size:14pt;\">Agua disponible inicialmente en el mapa</span></p></body></html>")
#endif // QT_CONFIG(tooltip)
