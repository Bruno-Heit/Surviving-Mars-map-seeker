...
"}")
        ...
        self.frame_dustdevils.setMinimumSize(QSize(276, 41))
#if QT_CONFIG(tooltip)
        ...
        self.label_dd_icon.setMinimumSize(QSize(166, 41))
        ...
        self.frame_duststorms.setMinimumSize(QSize(276, 41))
#if QT_CONFIG(tooltip)
        ...
        self.label_ds_icon.setMinimumSize(QSize(166, 41))
        ...
        self.frame_meteors.setMinimumSize(QSize(235, 41))
#if QT_CONFIG(tooltip)
        ...
        self.label_met_icon.setMinimumSize(QSize(166, 41))
        ...
        self.frame_coldwaves.setMinimumSize(QSize(235, 41))
#if QT_CONFIG(tooltip)
        ...
        self.label_cw_icon.setMinimumSize(QSize(166, 41))
