...
"}")
        ...
        self.label_coords.setToolTip(u"<html><head/><body><p>La coordenada del mapa teniendo en cuenta latitud(N/S) y longitud(W/E).</p></body></html>")
...
#if QT_CONFIG(tooltip)
        self.label_altitude.setToolTip(u"<html><head/><body><p>La altitud del mapa.</p></body></html>")
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_topography.setToolTip(u"<html><head/><body><p>La topograf\u00eda del mapa.</p></body></html>")
#endif // QT_CONFIG(tooltip)
